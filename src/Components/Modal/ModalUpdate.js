...
const ModalUpdate = props => {
  const initialFormState = { 
    id_book: props.id_book, image_url: props.image_url, title: props.title, 
    author: props.author, id_genre : props.id_genre, id_year: props.id_year , 
    id_status: props.id_status, description: props.description}
  ...
  const onSubmit = (e) => {
    e.preventDefault()
    console.log(book)
    axios.put(`http://localhost:8000/api/library/edit/${book.id_book}`, book)
  ...
  return (
    <div id={modalId} className='modal modal-edit'>
      <div className='modal-content'>
        ...
        <div className='row'>
          <form onSubmit={onSubmit}>
            ...
            <label className='book_year' htmlFor="book_year">Book Year</label>
            </div>
            <div className='input-field col m12'>
            ...
            <label className='book_status' htmlFor="book_status">Book Status</label>
            </div>
...
//   const { modalId, modalTitle, onChange,image_url,title,author,id_year,id_genre,id_status,description} = props;
//   return (
...
//             <div className='input-field col m12'>
//               <i className='material-icons prefix'>book</i>
//               <select value={book.id_genre} onChange={onChangeG} name='id_genre'>
//                 <option value="0">Choose Genre</option>
...
//             <div className='input-field col m12'>
//               <i className='material-icons prefix'>date_range</i>
//               <select value={book.id_year} onChange={onChangeBY} name='id_year'>
//               <option value="0">Choose Year</option>
//               <option value="1">2012</option>
//               <option value="2">2013</option>
//               <option value="3">2014</option>
...
//             <div className='input-field col m12'>
//               <i className='material-icons prefix'>event_available</i>
//               <select value={book.id_status} onChange={onChangeBS} name='id_status'>
//               <option value="0">Choose Book Status</option>
//               <option value="1">Available</option>
//               <option value="2">Not Available</option>
//             </select>              
